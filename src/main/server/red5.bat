...
REM Set up ssl options
set SSL_OPS=-Dsun.security.ssl.allowUnsafeRenegotiation=true -Dsun.security.ssl.allowLegacyHelloMessages=true
...
set SECURITY_OPTS=-Djava.security.debug=all -Djavax.net.debug=ssl
...
set JAVA_OPTS=%LOGGING_OPTS% %SSL_OPS% %SECURITY_OPTS% %JAVA_OPTS% %JVM_OPTS% %TOMCAT_OPTS% %NATIVE% %JYTHON_OPTS% 
